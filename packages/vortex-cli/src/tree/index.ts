import Yoga, { Direction, Display, Edge, FlexDirection, Gutter, Justify, MeasureMode, type Node } from "yoga-layout";
...
export class Box implements TreeNode {
    ...
    render(canvas: Canvas): void {
        ...
        using _clip = canvas.clip(left + border, top + border, right - border, bottom - border);
